    ...
    var body: some View {
        CustomList(title: "Keyboards") {
            ...
            Section(content: {
                ...
                Text("\(dictationEnabled ? "Dictation processes many voice inputs on Apple Vision Pro. Information will be sent to Apple in some cases. " : "")[About Dictation & Privacy...](#)")
            })
