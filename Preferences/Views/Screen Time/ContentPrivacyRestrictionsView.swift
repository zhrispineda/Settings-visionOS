    ...
    var body: some View {
        List {
            ...
            Section(content: {
                ...
                ListRowNavigationLabel(title: "Share My Location", subtitle: "Allow", content: EmptyView())
                ...
                ListRowNavigationLabel(title: "Apple Advertising", subtitle: "Allow", content: EmptyView())
            ...
            Section(content: {
                ListRowNavigationLabel(title: "Passcode Changes", subtitle: "Allow", content: EmptyView())
                ListRowNavigationLabel(title: "Account Changes", subtitle: "Allow", content: EmptyView())
                ListRowNavigationLabel(title: "Cellular Data Changes", subtitle: "Allow", content: EmptyView())
                ListRowNavigationLabel(title: "Reduce Loud Sounds", subtitle: "Allow", content: EmptyView())
                ListRowNavigationLabel(title: "Driving Focus", subtitle: "Allow", content: EmptyView())
                ListRowNavigationLabel(title: "TV Provider", subtitle: "Allow", content: EmptyView())
                ListRowNavigationLabel(title: "Background App Activities", subtitle: "Allow", content: EmptyView())
            }, header: {
                Text("Allow Changes:")
            })
            .disabled(!contentPrivacyRestrictionsEnabled)
